#!/usr/bin/env bash
# URL: /home/laboratorio/TFM/agarre_ros2_ws/scripts/run_panel_superpro.sh
# Summary: Full cold boot launcher with Gazebo/ROS env setup for the panel.
...
echo "[INFO] Panel SUPER PRO — COLD BOOT"
...
# ----------------------------
# 1) COLD BOOT: matar TODO siempre
# ----------------------------
...
# Fallback extra (por si algo queda vivo)
...
# Forzar “cold boot” también dentro del panel (doble seguridad)
...
# ----------------------------
# 4) Ejecutar panel (ruta REAL del paquete)
# ----------------------------
